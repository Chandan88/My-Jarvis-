...
if __name__=="__main__":
    ...
    #Logic for executing task based on query
        if 'tell me your details please' in query:
            speak('Greetings, I am JARVIS, I have 8GB RAM and 1TB Harddisk with 256GB SSD. And my System core i5 and 11th Generation.')


        elif 'what can you do for me' in query:
            speak('Well..I can do some small task for you..Because i am still learning.')
